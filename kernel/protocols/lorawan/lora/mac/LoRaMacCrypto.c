...
Description: LoRa MAC layer implementation （Lora mac实现）
...
/*!
 * MIC field computation initial data 信息完整性计算值  
 */
 ...
 */
static uint8_t Mic[16];  //Message Integrity Code信息完整性

/*!
 * Encryption aBlock and sBlock 加密
 */
...
/*!
 * \brief Computes the LoRaMAC frame MIC field  计算loramac 帧里面的MIC字段 
 *
